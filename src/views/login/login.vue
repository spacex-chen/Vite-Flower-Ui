  ...
  <div :class="{ container: true, 'sign-up-model': vari }">
    <div class="inner-left-container">
      <div class="login-content">
        <h1 style="color: white;">订花网</h1>
        <ElButton type="primary" @click="onClick" size="large">去注册</ElButton>
      </div>
      <img src="@/assets/images/login-bg.svg" class="image">
    </div>
    <div class="inner-right-container">
      ...
      <img src="@/assets/images/register-bg.svg" class="image">
    </div>
...
import register from '@/components/login/RegisterCom.vue'
const onClick = () => {
...
@media screen and (max-width: 992px) {
  ...
  .container.sign-up-model .inner-right-container .login-content
  .container.sign-up-model .inner-right-container .image{
    transform: translateY(1000px);
    transition: 1s ease-in-out;
  }
